...
class Robotiq2F85:
  ...
  def __init__(self, robot, tool):
    ...
    urdf = "../resources/robotiq_2f_85/robotiq_2f_85.urdf"
...
class PickPlaceEnv():
      ...
      def reset(self, config):
          ...
          self.robot_id = pybullet.loadURDF("../resources/ur5e/ur5e.urdf", [0, 0, 0],
                                            flags=pybullet.URDF_USE_MATERIAL_COLORS_FROM_MTL)
          self.ghost_id = pybullet.loadURDF("../resources/ur5e/ur5e.urdf", [0, 0, -10])  # For forward kinematics.
          ...
          for obj_name in obj_names:
              if ("block" in obj_name) or ("bowl" in obj_name):
                  ...
                  if object_type == "block":
                      ...
                      object_position[2] = 0
                      object_id = pybullet.loadURDF("../resources/bowl/bowl.urdf", object_position, useFixedBase=1)
...
if __name__ == '__main__':
    ...
    plt.imshow(img)
    plt.show()
    imageio.imwrite('../outputs/tmp.jpg', img)
